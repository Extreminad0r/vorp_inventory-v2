...
CONFIG.HOTBAR       = {
	...
	HOLD_KEY = `INPUT_SELECT_RADAR_MODE`,            -- Set to false to use hotbar slots with number keys only, or set a key that must be held while pressing a number key (e.g., ALT + number).
	SLOT_KEYS = {
